...
// const drawRoundedRect = (context: any, x: number, y: number, width: number, height: number, borderRadius: number) => {
//   if (borderRadius === 0) {
...
// class AvatarEditor extends React.Component<propTypes, any> {
//   static propTypes = {
